    ...
    >
      ...
      {raceName ? (
            ...
            <div className="grid grid-cols-2 gap-2 mt-3 pt-3 border-t border-slate-800/80 text-xs">
              {targetTimeText && (
                <div className="bg-surface rounded-lg p-2 flex items-center gap-2">
                  ...
                  <div>
                    <div className="text-[10px] text-muted-foreground uppercase">Tiempo Objetivo</div>
                    <div className="font-display font-bold text-white">{targetTimeText}</div>
                  </div>
                </div>
              )}
              ...
              {targetPaceText && (
                <div className="bg-surface rounded-lg p-2 flex items-center gap-2">
                  ...
                  <div>
                    <div className="text-[10px] text-muted-foreground uppercase">Ritmo Necesario</div>
                    <div className="font-display font-bold text-white">{targetPaceText} /km</div>
                  </div>
                </div>
              )}
            </div>
        ...
        <div className="flex items-center justify-between mt-2">
          <div>
            <h3 className="text-base font-bold text-slate-300 tracking-tight group-hover:text-primary transition-colors">
